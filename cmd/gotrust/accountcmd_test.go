...
Repeat passphrase: {{.InputLine "somentrusting else"}}
...
`)
	...
	files, err := ioutil.ReadDir(filepath.Join(gotrust.Datadir, "keystore"))
	if len(files) != 1 {
...
// https://github.com/ThePleasurable/go-trustmachine/issues/1785
