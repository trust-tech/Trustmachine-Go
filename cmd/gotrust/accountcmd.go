...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Trustmachine presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gotrust wallet import /path/to/my/presale.wallet

will prompt for your password and imports your trust presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Trustmachine presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gotrust wallet [options] /path/to/my/presale.wallet
...
between trustmachine nodes by simply copying.
...
`,
			},
			{
				...
				Description: `
    gotrust account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gotrust account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    gotrust account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    gotrust account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another trustmachine instance,
