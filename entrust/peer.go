...
// PeerInfo represents a short summary of the Trustmachine sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Trustmachine protocol version negotiated
...
// Handshake executes the entrust protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("entrust/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Trustmachine sub-protocol.
type peerSet struct {
