...
var ProtocolName = "entrust"

// Supported versions of the entrust protocol (first is primary).
var ProtocolVersions = []uint{entrust63, entrust62}
...
// entrust protocol message codes
const (
	// Protocol messages belonging to entrust/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to entrust/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
