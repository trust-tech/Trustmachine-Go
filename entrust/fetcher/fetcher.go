...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (entrust/61) or header (entrust/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (entrust/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both entrust/61 and entrust/62)
}
...
func (f *Fetcher) insert(peer string, block *types.Block) {
	...
	go func() {
		...
		default:
			// Somentrusting went very wrong, drop the peer
