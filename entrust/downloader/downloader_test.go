...
type downloadTester struct {
	...
	stateDb entrustdb.Database // Database used by the tester for syncing from peers
	peerDb  entrustdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = entrustdb.NewMemDatabase()
