...
// Syncing provides information when this nodes starts synchronising with the Trustmachine network and when it's finished.
...
type SyncingResult struct {
	...
	Status  trustmachine.SyncProgress `json:"status"`
}
