...
//
// entrust_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// entrust_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.EntrustSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "entrust_getBlockByNumber", "latest"); err != nil {
