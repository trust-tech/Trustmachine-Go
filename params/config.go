...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		Entrustash: new(EntrustashConfig),
	}
	...
	// introduced and accepted by the Trustmachine core developers.
	//
	...
	// fields.
	AllProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(math.MaxInt64) /*disabled*/, new(EntrustashConfig), nil}
	TestChainConfig    = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), nil, new(EntrustashConfig), nil}
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/trust-tech/EIPs/issues/150)
	...
	Entrustash *EntrustashConfig `json:"entrustash,omitempty"`
	Clique *CliqueConfig `json:"clique,omitempty"`
}

// EntrustashConfig is the consensus engine configs for proof-of-work based sealing.
type EntrustashConfig struct{}

// String implements the stringer interface, returning the consensus engine details.
func (c *EntrustashConfig) String() string {
	return "entrustash"
}
