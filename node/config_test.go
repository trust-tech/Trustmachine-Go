...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gotrust.ipc", false, filepath.Join(os.TempDir(), "gotrust.ipc")},
		{"data", "gotrust.ipc", false, "data/gotrust.ipc"},
		{"data", "./gotrust.ipc", false, "./gotrust.ipc"},
		{"data", "/gotrust.ipc", false, "/gotrust.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gotrust.ipc", true, `\\.\pipe\gotrust.ipc`},
		{"data", "gotrust.ipc", true, `\\.\pipe\gotrust.ipc`},
		{"data", `\\.\pipe\gotrust.ipc`, true, `\\.\pipe\gotrust.ipc`},
	}
