...
func New(conf *Config) (*Node, error) {
	...
	// We rely on this in cmd/gotrust.
...
func (n *Node) OpenDatabase(name string, cache, handles int) (entrustdb.Database, error) {
	if n.config.DataDir == "" {
		return entrustdb.NewMemDatabase()
	}
	return entrustdb.NewLDBDatabase(n.config.resolvePath(name), cache, handles)
}
