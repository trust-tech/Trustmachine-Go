...
// Whisper represents a dark communication interface through the Trustmachine
...
type Whisper struct {
	...
	expirations map[uint32]*set.SetNonTS  // Message expiration pool (TODO: somentrusting lighter)
...
// New creates a Whisper client ready to communicate through the Trustmachine P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
