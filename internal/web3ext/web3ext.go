...
// package web3ext contains gotrust specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	[
		...
		new web3._extend.Method({
			...
			call: 'entrust_signTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'submitTransaction',
			call: 'entrust_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'getRawTransaction',
			call: 'entrust_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getRawTransactionFromBlock',
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'entrust_getRawTransactionByBlockHashAndIndex' : 'entrust_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
	...
	[
		new web3._extend.Property({
			...
			getter: 'entrust_pendingTransactions',
