...
const (
	...
	EPOLL_CTL_DEL                    = 0x2
	EPOLL_CTL_MOD                    = 0x3
	ENTRUST_P_1588                       = 0x88f7
	ENTRUST_P_8021AD                     = 0x88a8
	ENTRUST_P_8021AH                     = 0x88e7
	ENTRUST_P_8021Q                      = 0x8100
	ENTRUST_P_80221                      = 0x8917
	ENTRUST_P_802_2                      = 0x4
	ENTRUST_P_802_3                      = 0x1
	ENTRUST_P_802_3_MIN                  = 0x600
	ENTRUST_P_802_EX1                    = 0x88b5
	ENTRUST_P_AARP                       = 0x80f3
	ENTRUST_P_AF_IUCV                    = 0xfbfb
	ENTRUST_P_ALL                        = 0x3
	ENTRUST_P_AOE                        = 0x88a2
	ENTRUST_P_ARCNET                     = 0x1a
	ENTRUST_P_ARP                        = 0x806
	ENTRUST_P_ATALK                      = 0x809b
	ENTRUST_P_ATMFATE                    = 0x8884
	ENTRUST_P_ATMMPOA                    = 0x884c
	ENTRUST_P_AX25                       = 0x2
	ENTRUST_P_BATMAN                     = 0x4305
	ENTRUST_P_BPQ                        = 0x8ff
	ENTRUST_P_CAIF                       = 0xf7
	ENTRUST_P_CAN                        = 0xc
	ENTRUST_P_CANFD                      = 0xd
	ENTRUST_P_CONTROL                    = 0x16
	ENTRUST_P_CUST                       = 0x6006
	ENTRUST_P_DDCMP                      = 0x6
	ENTRUST_P_DEC                        = 0x6000
	ENTRUST_P_DIAG                       = 0x6005
	ENTRUST_P_DNA_DL                     = 0x6001
	ENTRUST_P_DNA_RC                     = 0x6002
	ENTRUST_P_DNA_RT                     = 0x6003
	ENTRUST_P_DSA                        = 0x1b
	ENTRUST_P_ECONET                     = 0x18
	ENTRUST_P_EDSA                       = 0xdada
	ENTRUST_P_FCOE                       = 0x8906
	ENTRUST_P_FIP                        = 0x8914
	ENTRUST_P_HDLC                       = 0x19
	ENTRUST_P_HSR                        = 0x892f
	ENTRUST_P_IEEE802154                 = 0xf6
	ENTRUST_P_IEEEPUP                    = 0xa00
	ENTRUST_P_IEEEPUPAT                  = 0xa01
	ENTRUST_P_IP                         = 0x800
	ENTRUST_P_IPV6                       = 0x86dd
	ENTRUST_P_IPX                        = 0x8137
	ENTRUST_P_IRDA                       = 0x17
	ENTRUST_P_LAT                        = 0x6004
	ENTRUST_P_LINK_CTL                   = 0x886c
	ENTRUST_P_LOCALTALK                  = 0x9
	ENTRUST_P_LOOP                       = 0x60
	ENTRUST_P_LOOPBACK                   = 0x9000
	ENTRUST_P_MACSEC                     = 0x88e5
	ENTRUST_P_MOBITEX                    = 0x15
	ENTRUST_P_MPLS_MC                    = 0x8848
	ENTRUST_P_MPLS_UC                    = 0x8847
	ENTRUST_P_MVRP                       = 0x88f5
	ENTRUST_P_PAE                        = 0x888e
	ENTRUST_P_PAUSE                      = 0x8808
	ENTRUST_P_PHONET                     = 0xf5
	ENTRUST_P_PPPTALK                    = 0x10
	ENTRUST_P_PPP_DISC                   = 0x8863
	ENTRUST_P_PPP_MP                     = 0x8
	ENTRUST_P_PPP_SES                    = 0x8864
	ENTRUST_P_PRP                        = 0x88fb
	ENTRUST_P_PUP                        = 0x200
	ENTRUST_P_PUPAT                      = 0x201
	ENTRUST_P_QINQ1                      = 0x9100
	ENTRUST_P_QINQ2                      = 0x9200
	ENTRUST_P_QINQ3                      = 0x9300
	ENTRUST_P_RARP                       = 0x8035
	ENTRUST_P_SCA                        = 0x6007
	ENTRUST_P_SLOW                       = 0x8809
	ENTRUST_P_SNAP                       = 0x5
	ENTRUST_P_TDLS                       = 0x890d
	ENTRUST_P_TEB                        = 0x6558
	ENTRUST_P_TIPC                       = 0x88ca
	ENTRUST_P_TRAILER                    = 0x1c
	ENTRUST_P_TR_802_2                   = 0x11
	ENTRUST_P_TSN                        = 0x22f0
	ENTRUST_P_WAN_PPP                    = 0x7
	ENTRUST_P_WCCP                       = 0x883e
	ENTRUST_P_X25                        = 0x805
	ENTRUST_P_XDSA                       = 0xf8
	EXTA                             = 0xe
	EXTB                             = 0xf
	...
	TUNGETVNENTRUSTDRSZ                  = 0x400454d7
	...
	TUNSETVNENTRUSTDRSZ                  = 0x800454d8
