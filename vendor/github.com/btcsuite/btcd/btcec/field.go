...
// Add2 adds the passed two field values togotruster and stores the result in f.
//
// The field value is returned to support chaining.  This enables syntax like:
...
// Mul2 multiplies the passed two field values togotruster and stores the result
