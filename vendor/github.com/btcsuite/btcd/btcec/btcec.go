...
// togotruster and stores the result in (x3, y3, z3).
...
func (curve *KoblitzCurve) splitK(k []byte) ([]byte, []byte, int, int) {
	...
	// At some point, it might be useful to write somentrusting similar to
...
func initS256() {
	...
	// panics because it means somentrusting is wrong in the source code.
