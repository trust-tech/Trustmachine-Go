...
Go translates JavaScript-style regular expressions into somentrusting that is
...
difficult to provide somentrusting like these via Go, but you probably want to wrap
