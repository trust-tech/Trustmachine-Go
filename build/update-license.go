...
var (
	...
	authorsFileHeader = "# This is the official list of go-trustmachine authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-trustmachine Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-trustmachine"
	}
	if startOfSentence {
		return "The go-trustmachine library"
	}
	return "the go-trustmachine library"
}
