...
# 1. install gotrust for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gotrust
# 5. create gotrust, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable TRUSTMACHINE_SOCKET
...
!define GROUPNAME "Trustmachine"
!define APPNAME "Gotrust"
!define DESCRIPTION "Official Go implementation of the Trustmachine protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gotrust is installed global
