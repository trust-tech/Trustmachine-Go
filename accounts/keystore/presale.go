...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/ThePleasurable/pyentrustsaletool

		pyentrustsaletool generates the encryption key from password by
	...
	*/
	...
	entrustPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(entrustPriv)
	...
	expectedAddr := preSaleKeyStruct.EntrustAddr
