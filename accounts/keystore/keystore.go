...
// See https://github.com/ThePleasurable/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Trustmachine presale wallet and stores
