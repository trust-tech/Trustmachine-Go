...
// Package accounts implements high level Trustmachine account management.
package accounts
...
type Account struct {
	Address common.Address `json:"address"` // Trustmachine account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain trustmachine.ChainStateReader)
