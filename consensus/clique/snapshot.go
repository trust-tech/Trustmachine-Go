...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db entrustdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db entrustdb.Database) error {
