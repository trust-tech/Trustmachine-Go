...
var (
	...
	// errInvalidVote is returned if a nonce value is somentrusting else that the two
...
// ecrecover extracts the Trustmachine account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Trustmachine address
...
// Trustmachine testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     entrustdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Trustmachine address of the signing key
...
func New(config *params.CliqueConfig, db entrustdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Trustmachine address recovered
