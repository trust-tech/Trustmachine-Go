...
// cacheSize calculates and returns the size of the entrustash verification cache that
...
// datasetSize calculates and returns the size of the entrustash mining dataset that
