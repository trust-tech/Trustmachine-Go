...
// Package chequebook package wraps the 'chequebook' Trustmachine smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in trust; (auto)cashing cheques in trust
// as well as (auto)depositing trust to the chequebook contract.
package chequebook
...
// * depositing trust to the chequebook
// * watching incoming trust
...
// Cash cashes the cheque by sending an Trustmachine transaction.
