...
import (
	...
	"github.com/trust-tech/go-trustmachine/swarm/fuse"
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *entrustclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
