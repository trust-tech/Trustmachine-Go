...
type OdrBackend interface {
	Database() entrustdb.Database
	Retrieve(ctx context.Context, req OdrRequest) error
}

// OdrRequest is an interface for retrieval requests
type OdrRequest interface {
	StoreResult(db entrustdb.Database)
}
...
func (req *TrieRequest) StoreResult(db entrustdb.Database) {
	storeProof(db, req.Proof)
}

// storeProof stores the new trie nodes obtained from a merkle proof in the database
func storeProof(db entrustdb.Database, proof []rlp.RawValue) {
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db entrustdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db entrustdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db entrustdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db entrustdb.Database) {
