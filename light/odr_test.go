...
type odrTestFn func(ctx context.Context, db entrustdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) []byte

func TestOdrGetBlockLes1(t *testing.T) { testChainOdr(t, 1, 1, odrGetBlock) }

func odrGetBlock(ctx context.Context, db entrustdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) []byte {
...
func odrGetReceipts(ctx context.Context, db entrustdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) []byte {
...
func odrAccounts(ctx context.Context, db entrustdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) []byte {
...
func odrContractCall(ctx context.Context, db entrustdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) []byte {
...
func testChainOdr(t *testing.T, protocol int, expFail uint64, fn odrTestFn) {
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, entrustash.NewFullFaker(), evmux)
