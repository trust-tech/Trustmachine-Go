...
// Package types contains data types related to Trustmachine consensus.
package types
...
// Header represents a block header in the Trustmachine blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) togotruster.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Trustmachine blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package entrust to track
...
// [deprecated by entrust/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for entrust protocol, etc.
...
// DecodeRLP decodes the Trustmachine
...
// EncodeRLP serializes b into the Trustmachine RLP block format.
