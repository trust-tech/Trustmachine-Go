...
func SetupGenesisBlock(db entrustdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) Commit(db entrustdb.Database) (*types.Block, error) {
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db entrustdb.Database) *types.Block {
...
func GenesisBlockForTesting(db entrustdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Trustmachine main net genesis block.
...
// DevGenesisBlock returns the 'gotrust --dev' genesis block.
