...
type Context struct {
	...
	// sufficient trust to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers trust from one account to the other
...
// EVM is the Trustmachine Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) trustmachine virtual machine
