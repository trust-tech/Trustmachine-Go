...
func makeTestState() (Database, *entrustdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := entrustdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db entrustdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db entrustdb.Database, root common.Hash) error {
...
func checkStateConsistency(db entrustdb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	dstDb, _ := entrustdb.NewMemDatabase()
