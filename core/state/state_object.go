...
// stateObject represents an Trustmachine account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of trustmachine address of the account
	data     Account
	db       *StateDB
...
// Account is the Trustmachine consensus representation of accounts.
