...
// See https://github.com/trust-tech/EIPs/issues/176 for the test format specification.
...
func makePreState(db entrustdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/trust-tech/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
