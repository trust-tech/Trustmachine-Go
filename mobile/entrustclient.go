...
// Contains a wrapper for the Trustmachine client.
...
type TrustmachineClient struct {
	client *entrustclient.Client
}

// NewTrustmachineClient connects a client to the given URL.
func NewTrustmachineClient(rawurl string) (client *TrustmachineClient, _ error) {
	rawClient, err := entrustclient.Dial(rawurl)
	return &TrustmachineClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *TrustmachineClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *TrustmachineClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *TrustmachineClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *TrustmachineClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *TrustmachineClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *TrustmachineClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *TrustmachineClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *TrustmachineClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *TrustmachineClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *TrustmachineClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *TrustmachineClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *TrustmachineClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *TrustmachineClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *TrustmachineClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *TrustmachineClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *TrustmachineClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *TrustmachineClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *TrustmachineClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *TrustmachineClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *TrustmachineClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *TrustmachineClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *TrustmachineClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *TrustmachineClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *TrustmachineClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *TrustmachineClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *TrustmachineClient) SendTransaction(ctx *Context, tx *Transaction) error {
