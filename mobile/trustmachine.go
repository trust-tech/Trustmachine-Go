...
// Contains all the wrappers from the go-trustmachine root package.
...
// the Trustmachine network.
type SyncProgress struct {
	progress trustmachine.SyncProgress
}
...
type FilterQuery struct {
	query trustmachine.FilterQuery
}
